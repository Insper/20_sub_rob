...
def recebe(msg):
    ...
    frame_names = {"camera_rgb_optical_frame":"Coordenadas da câmera",  "base_link": "Base do robô"}
    frame_coords = {"camera_rgb_optical_frame":dict(),  "base_link":dict()}
...
"""
    ...
    rospy.init_node("transformacoes")
